    ...
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
            return MegaPixImage;
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)); // for AMD loader
    } else {
...
var Promise = __webpack_require__(4),
    BlobFormDataShim = __webpack_require__(3),
    exif = __webpack_require__(5),
    MegaPixImage = __webpack_require__(7),
    JPEGEncoder = __webpack_require__(6);
...
function fileUpload(file, opts) {
    ...
    if (!file) throw new Error('没有接受到图片');
    ...
    return new Promise(function (resolve, reject) {
        ...
        img.onload = function () {
            that._getBase64().then(function (base64) {
                ...
                if (_typeof(that.file) === 'object' && base64.length > that.file.size) {
...
fileUpload.prototype._getBase64 = function () {
    var that = this,
        img = that.img,
        file = that.file,
        canvas = that.canvas;
    ...
    return new Promise(function (resolve) {
        try {
            ...
            exif.getData((typeof file === 'undefined' ? 'undefined' : _typeof(file)) === 'object' ? file : img, function () {
...
fileUpload.prototype._createBase64ForOldIOS = function () {
    var that = this,
        img = that.img,
        canvas = that.canvas,
...
fileUpload.prototype._createBase64 = function () {
    var that = this,
        resize = that.resize,
        img = that.img,
        canvas = that.canvas,
...
fileUpload.prototype._getResize = function () {
    var that = this,
        img = that.img,
        defaults = that.defaults,
...
var upload = function upload(file, opts) {
    return new fileUpload(file, opts);
};
